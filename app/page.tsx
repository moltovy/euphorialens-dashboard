      ...
      <table className="w-full min-w-[980px] border-collapse text-sm">
        <thead className="bg-[#120d1d]/95 text-left text-xs uppercase tracking-[0.12em] text-euphoria-muted">
          <tr>
            ...
            <th className="px-4 py-3">Payout Candidate</th>
      ...
      <main className="px-4 py-8 md:py-10">
        ...
        <section className="mx-auto mt-10 max-w-7xl">
          <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            description="Ranked by lifecycle-derived on-chain volume across all indexed trading accounts. Net PNL remains an estimated secondary metric."
            />
            <Link
              href="/leaderboard"
