...
export type TraderRecord = {
  ...
  publicIdentityFirstSeenAt?: string | null;
  publicIdentityLastSeenAt?: string | null;
  publicIdentityMatchedOpenCount?: number | null;
  publicIdentityUserCountForAccount?: number | null;
  volumeUsd: number;
  pnlUsd?: number | null;
...
export type PublicDashboardMetadata = {
  ...
  publicWsIdentityBridgeAvailable?: boolean;
  publicWsIdentityBridgeRows?: number;
  publicWsIdentityPublicUserCount?: number;
  publicWsIdentityPlatformAccountCount?: number;
  publicWsIdentityMappedPlatformAccountCount?: number;
  publicWsIdentityMappedLifecycleRows?: number;
  publicWsIdentityLastSeenAt?: string | null;
  publicWsProfileJoinIncluded?: boolean;
